                ...
                <span class="mr-1">مرحبا
                  ...
                  <img  style="height: 35px;" src="{{asset(auth()->guard('admin')->user()->photo??'assets/admin/images/portrait/small/avatar-s-6.png')}}" alt="avatar"><i></i></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="{{route('password.edit.profile')}}"><i
                                    class="ft-user"></i> تغيير كلمة السر </a>
                            <div class="dropdown-divider"></div>
                  ...
                  <span
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{asset('asserts/admin/images/portrait/small/avatar-s-19.png')}}"
                               alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
